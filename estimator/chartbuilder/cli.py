...
# create chart example :      superset chartbuilder_create_chart -t rulebase_nullcheck -g globalsignin -c city
# create dashboard example :  superset chartbuilder_create_dashboard -t rulebase_nullcheck -g globalsignin
...
def chartbuilder_create_chart(type, gamecode, column):
  ...
  from superset.chartbuilder.utils import create_chart
...
def chartbuilder_create_dashboard(type, gamecode):
  ...
  from superset.chartbuilder.utils import create_dashboard
